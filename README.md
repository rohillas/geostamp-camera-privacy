...
Live at: https://rohillas.github.io/geostamp-camera-privacy/

The app itself also ships the full policy text on-device (an in-app screen,
no network call), so this page exists only to satisfy Play Console's
required URL field.
